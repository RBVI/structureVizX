...
import edu.ucsf.rbvi.structureVizX.internal.ui.AlignStructuresDialog;
import edu.ucsf.rbvi.structureVizX.internal.ui.ModelNavigatorDialog;
...
public class StructureManager {
	...
	public StructureManager(CyServiceRegistrar registrar, boolean haveGUI) {
		...
		chimera = new ChimeraIO(this);
		chimeraManager = new ChimeraManager(this, chimera);
	...
	public File saveChimeraImage() {
		...
		try {
			...
			chimera.sendChimeraCommand("set bgTransparency", false);
			chimera.sendChimeraCommand("copy file " + tmpFile.getAbsolutePath() + " png",
					true);
			chimera.sendChimeraCommand("unset bgTransparency", false);
